$(document).ready(function () {
    ...
    function fetchMovies(page) {
        ...
        if (!movieQuery) {
            console.log("Movie query is empty.");
            return;
        }

        const tmdbURL = `https://api.themoviedb.org/3/search/movie?query=${movieQuery}&language=en-US&page=${page}&api_key=${TMDB_api_key}`
    ...
    function fetchSeries(page) {
        ...
        const tmdbURL = `https://api.themoviedb.org/3/search/tv?query=${seriesQuery}&language=en-US&page=${page}&api_key=${TMDB_api_key}`
